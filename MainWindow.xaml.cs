...
public partial class MainWindow : Window
{
    ...
    private void LoadCategories()
    {
        ...
        CategoryFilterComboBox.SelectedValue = 0;
    ...
    private void LoadProducts()
    {
        ...
        StockProductComboBox.ItemsSource = comboProducts;
        SaleProductComboBox.ItemsSource = comboProducts;

        if (StockProductComboBox.Items.Count > 0 && StockProductComboBox.SelectedIndex < 0)
            StockProductComboBox.SelectedIndex = 0;

        if (SaleProductComboBox.Items.Count > 0 && SaleProductComboBox.SelectedIndex < 0)
            SaleProductComboBox.SelectedIndex = 0;
    }
    ...
    private static string GenerateSku() => $"ART-{DateTime.Now:yyyyMMddHHmmss}";
}
