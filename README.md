...
├── DatabaseService.cs        (sloj za rad sa bazom)
├── Category.cs, Product.cs, StockMovement.cs,
│   Sale.cs, SaleItem.cs, SaleCartItem.cs,
│   DashboardStats.cs, ReportRow.cs   (modeli)
└── database-schema.sql       (šema baze)
```
